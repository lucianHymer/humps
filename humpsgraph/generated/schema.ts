...
export class Transfer extends Entity {
  ...
  set dna(value: Bytes) {
    this.set("dna", Value.fromBytes(value));
  }
  ...
  set motherId(value: BigInt) {
    this.set("motherId", Value.fromBigInt(value));
  }
  ...
  set fatherId(value: BigInt) {
    this.set("fatherId", Value.fromBigInt(value));
  }
}
